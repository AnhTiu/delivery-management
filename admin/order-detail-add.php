...
<div class="container py-5" style="background: linear-gradient(135deg, #f8ffae 0%, #43c6ac 100%); min-height: 100vh;">
    <div class="row mb-4">
        <div class="col-12 text-center">
            <h1 class="display-4 fw-bold mb-2 text-gradient">Thêm sản phẩm vào đơn hàng #<?php echo $id; ?></h1>
            <p class="lead text-muted mb-4">Nhập thông tin sản phẩm để thêm vào đơn hàng</p>
        </div>
    </div>
    <?php if (!empty($error)): ?>
                ...
                <div class="card-body p-4">
                    <form method="POST" action="">
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-lg btn-gradient-primary rounded-pill shadow"><i class="bi bi-plus-circle"></i> Thêm sản phẩm</button>
                            <a href="/delivery-management/admin/order-view.php?id=<?php echo $id; ?>" class="btn btn-lg btn-outline-secondary rounded-pill">Quay lại chi tiết đơn hàng</a>
                        </div>
                    </form>
                </div>
            </div>
